...
public class GoogleAdsManager : MonoBehaviour
{
    ...
    public UnityAction interstitialAdClosedEvent;
    public UnityAction rewardedAdClosedEvent;
    ...
    void Start()
    {
        ...
        MobileAds.Initialize((InitializationStatus initStatus) =>
        {
            ...
            LoadInterstitialAd();
            LoadRewardedAd();
            interstitialAdClosedEvent += () => GivenInterReward();
            rewardedAdClosedEvent += () => GivenVideoReward();
        });
    }
    ...
    private void InterstitialEventHandlers(InterstitialAd interstitialAd)
    {
        ...
        interstitialAd.OnAdPaid += (AdValue adValue) =>
        {
            Debug.Log(String.Format("Interstitial ad paid {0} {1}.",
                adValue.Value,
                adValue.CurrencyCode));
            if (interstitialAdClosedEvent != null)
            {
        ...
        interstitialAd.OnAdFullScreenContentFailed += (AdError error) =>
        {
            Debug.LogError("Interstitial ad failed to open full screen content " +
                           "with error : " + error);
            InterstitialReloadHandler(interstitialAd);
        };
    }
    ...
    public void LoadRewardedAd()
    {
        ...
        RewardedAd.Load(rewardedAdUnitId, adRequest,
            (RewardedAd ad, LoadAdError error) =>
            {
                ...
                _rewardedAd = ad;
                RewardEventHandlers(_rewardedAd);
                RewardReloadHandler(_rewardedAd);
            });
    }

    private void GivenVideoReward()
    {
    ...
    private void RewardEventHandlers(RewardedAd ad)
    {
        // Raised when the ad is estimated to have earned money.
    ...
    private void RewardReloadHandler(RewardedAd ad)
    {
        // Raised when the ad closed full screen content.
        ad.OnAdFullScreenContentClosed += () =>
        {
